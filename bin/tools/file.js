...
module.exports = {
  ...
  async archiveFile () {
    return new Promise((resolve, reject) => {
      console.log(`archive ${ deployConfig.archiveRootDir }.tar`)
      ...
      output.on('close', err => {
        ...
        console.log(chalk.cyan(`DONE  Create archive file complete. The ${ deployConfig.archiveRootDir }.tar has ${ archive.pointer() } bytes.\n`))
        resolve()
      })
